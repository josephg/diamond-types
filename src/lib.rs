...
// struct MarkerEntry {
//     len: u32,
//     ptr: NonNull<NodeLeaf<CRDTSpan, ContentIndex>>
// }
//
...
//     type Output = NonNull<NodeLeaf<CRDTSpan, ContentIndex>>;
//
...
//
//     marker_tree: Pin<Box<RangeTree<CRDTSpan, ContentIndex>>>,
//
...
//     }
//
//     fn notify(client_data: &mut Vec<ClientData>, entry: CRDTSpan, ptr: NonNull<NodeLeaf<CRDTSpan, ContentIndex>>) {
