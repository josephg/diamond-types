...
//     }
//
//     pub(crate) fn list_cursor_at_content_pos<'a>(&self, list: &'a ListCRDT, pos: usize) -> (<&'a OldRangeTree as Cursors>::Cursor, usize) {
...
//     }
//
//     fn map_to_list_cursor<'a>(&self, mut map_cursor: Cursor<PositionRun, FullMetricsU32, DEFAULT_IE, DEFAULT_LE>, list: &'a ListCRDT, stick_end: bool) -> (<&'a OldRangeTree as Cursors>::Cursor, usize) {
