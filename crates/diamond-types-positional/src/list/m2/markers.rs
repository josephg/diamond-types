...
pub struct MarkerEntry<E: ContentTraits, I: TreeMetrics<E>> {
    ...
    pub len: usize,
    pub ptr: Option<NonNull<NodeLeaf<E, I, DEFAULT_IE, DEFAULT_LE>>>,
}
...
impl<E: ContentTraits, I: TreeMetrics<E>> MarkerEntry<E, I> {
    pub fn unwrap_ptr(&self) -> NonNull<NodeLeaf<E, I, DEFAULT_IE, DEFAULT_LE>> {
        self.ptr.unwrap()
    }
}

impl<E: ContentTraits, I: TreeMetrics<E>> Searchable for MarkerEntry<E, I> {
    type Item = Option<NonNull<NodeLeaf<E, I, DEFAULT_IE, DEFAULT_LE>>>;
