...
type SpaceIndex = Pin<Box<ContentTreeRaw<MarkerEntry<YjsSpan, DocRangeIndex, DOC_IE, DOC_LE>, RawPositionIndex, INDEX_IE, INDEX_LE>>>;
...
pub struct ListCRDT {
    ...
    range_tree: Pin<Box<ContentTreeRaw<YjsSpan, DocRangeIndex, DOC_IE, DOC_LE>>>,
